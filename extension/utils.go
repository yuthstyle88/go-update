...
func GetS3ExtensionBucketHost(id string) string {
	...
	return lookupEnvFallback("S3_EXTENSIONS_BUCKET_HOST", "ibrowe-core-ext-dev.s3.ibrowe.com")
}
...
func GetComponentUpdaterHost() string {
	return lookupEnvFallback("COMPONENT_UPDATER_HOST", "componentupdater.ibrowe.com")
}
